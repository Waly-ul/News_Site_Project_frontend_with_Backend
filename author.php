            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    if (isset($_REQUEST['aid'])) {
                        ...
                        $sql2 = "SELECT * from post join user on post.author = user.user_id where post.author = $aid";
                    ...
                    $sql2 = "SELECT * from post where post.author = $aid";
                    $result2 = mysqli_query($con, $sql2) or die("Query Failed");
                    ...
                    if (mysqli_num_rows($result2) > 0) {
                        ...
                        if ($page > 1) {
                            echo '<li><a href="author.php?aid=' . $aid . '&page=' . ($page - 1) . '">Previous</a></li>';
                        }
